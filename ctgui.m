...
% Last Modified by GUIDE v2.5 02-Jan-2019 22:59:27
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
proj   = str2num(get(handles.proj,'string'))
sensor = str2num(get(handles.sensor,'string'))
dim    = str2num(get(handles.dim,'string'))
path   = get(handles.fileT,'string')

ct(proj,sensor,dim,path);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
path = uigetfile({'*.png;*.jpg;*.bmp','Fotograf (jpg png bmp)'});
set(handles.fileT,'string',path);
